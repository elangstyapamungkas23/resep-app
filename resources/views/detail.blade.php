...
$userRating = $resep->ratings->where('user_id', 1)->first();
@endphp
    ...
    <section class="px-16 py-10">
        ...
        <div class="grid grid-cols-2 gap-14 items-center">
            ...
            <div>
                ...
                @if($resep->gambar)
                    ...
                    <img
                        ...
                        class="w-full h-[600px] object-cover rounded-[40px] shadow-2xl"
                    >
            ...
            <div>
                ...
                <p class="text-orange-500 font-semibold text-xl mb-4">
                    Resep Pilihan
                </p>

                <h1 class="text-6xl font-black text-slate-900 mb-8">
                    {{ $resep->nama_resep }}
                </h1>
...
@endif
                ...
                <!-- FAVORIT BUTTON -->
@php
$isFavorit = $resep->favorits->where('user_id', 1)->first();
@endphp
